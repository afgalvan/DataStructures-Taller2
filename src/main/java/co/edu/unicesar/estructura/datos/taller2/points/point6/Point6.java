...
public class Point6 {
    ...
    public static void main(String[] args) {
        ...
        Runnable askData1 = () -> askData1(list1);
        Runnable askData2 = () -> askData2(list2);
    ...
    public static void runAction(
        ...
        SimplyLinkedList.SimplyNode<ActionItem> cursor2 = list2.getFirst();
        while (cursor2 != null) {
            if (cursor2.getItem().getAction() == 'A') {
                list1.add(cursor2.getItem().getCode());
            } else if (cursor2.getItem().getAction() == 'R') {
                deleteNode(list1, cursor2.getItem().getCode());
            }
            cursor2 = cursor2.getNext();
        }
    }

    public static void deleteNode(SimplyLinkedList<Integer> list1, int code) {
